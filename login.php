...
<body>
    <main class="auth-container">
        ...
        <form method="POST">
            ...
            <input type="hidden" name="redirect" value="<?php htmlspecialchars($redirect, ENT_QUOTES | ENT_SUBSTITUTE); ?>">
            <input type="hidden" name="email" placeholder="Seu e-mail" value="<?php htmlspecialchars($email, ENT_QUOTES | ENT_SUBSTITUTE); ?>">
